...
export default function Home() {
    ...
    const handleUploadComplete = async (base4Image: string) => {
    ...
    <section className="hero">
      <div className="announce">
        ...
        <p className="subtitle">
          Roomify is an AI-first design environment that empowers you
    ...
    <section className="projects">
      <div className="section-inner">
        <div className="section-head">
          <div className="copy">
            <h2>Projects</h2>
            <p>Your latest work and shared community projects, all
              in one place.</p>
          </div>
        </div>
